...
var conc = {
    ...
    fluctBoostPower: new Decimal("1.2"),
...
const aConcGainDisp = document.getElementById("concFluctBoostDisp")
...
aUpgrade8.addEventListener("click", ()=>{
    if(alpha.amt.greaterThanOrEqualTo("1e5") == true & isAUpgrade8Bought){
...
function gainCalc(){
    ...
    if(isAUpgrade8Bought == true || isConcentrationUnlocked == true){
...
function concentration(){
    ...
    if(conc.estimated.greaterThanOrEqualTo("1") == true){
        ...
        conc.fluctBoost = Decimal.pow(conc.fluctBoostPower, conc.amt)
    }
}
