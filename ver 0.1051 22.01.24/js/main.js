...
function fluctuation(){
    fluct.current = Decimal.add((Decimal.times((Math.round(Math.random()*100)/100), Decimal.sub(fluct.max, "1"))), "1")
...
aUpgrade5.addEventListener("click", function(){
    if(alpha.amt.greaterThanOrEqualTo("150") == true & isAUpgrade5Bought == false){
